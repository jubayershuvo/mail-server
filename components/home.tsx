    ...
    <>
      <main className="min-h-screen bg-white text-gray-800">
          ...
          {!loading && (
            ...
            >
              <Link href={session ? "/dashboard" : "/api/auth/signin"}>
                <button className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-full shadow-md text-lg">
          ...
          <div className="grid md:grid-cols-3 gap-10 text-center">
            {[
              ...
              },
              {
                ...
                title: "Unified API",
                desc: "Send and manage emails from multiple providers via a simple unified REST API.",
              },
              {
        ...
        <section className="py-20 px-6 bg-white max-w-6xl mx-auto">
          ...
          <div className="text-left text-sm bg-gray-100 p-6 rounded-xl shadow">
...
Body:
{
  ...
  "text": "<strong>Hello</strong> World!"
        ...
        <section className="bg-purple-50 py-20 px-6 text-center">
          ...
          <div className="flex justify-center gap-10 text-gray-700 text-4xl">
        ...
        <section className="bg-indigo-600 text-white text-center py-20 px-6">
          ...
          <p className="mb-6 text-sm">
            Bind your accounts and integrate mail-sending with just one API
            call.
          </p>
          <Link href={session ? "/dashboard" : "/api/auth/signin"}>
            <button className="bg-white text-indigo-600 px-8 py-3 rounded-full shadow-md hover:bg-gray-100">
